...
sudo su - planum
docker run -d --net="host" -v /var/run/docker.sock:/var/run/docker.sock -v /home/planum:/home/planum --entrypoint "bash /etc/init.sh" --name planum mobilab.azurecr.io/planum:latest
echo "done"
